//compare instance using hashable protocol
import Foundation
...
let obj1 = Employee(name: "sachin", salary: 40000)
let obj2 = Employee(name: "virat", salary: 40000)
let obj3 = Employee(name: "rohith", salary: 30000)
